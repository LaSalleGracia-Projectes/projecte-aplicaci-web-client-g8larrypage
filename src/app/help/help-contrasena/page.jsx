...
export default function PasswordHelp() {
  ...
  const translation = translationsHelpPassword[language] || translationsHelpPassword["es"];
    ...
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-grow container mx-auto px-4 mt-40">
        <div className="max-w-xl mx-auto bg-white p-6 rounded-lg shadow-md border border-gray-200">
          ...
          <h3 className="text-lg font-semibold mb-2">{translation.security_tips}</h3>
          <ul className="list-disc list-inside text-gray-600 mb-4">
            {translation.tips_list.map((tip, index) => (
              <li key={index}>{tip}</li>
            ))}
          </ul>
